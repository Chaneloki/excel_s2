...
# 整合Demo專用改動說明
# ------------------------------
# 本檔案複製自01_excel_simulator_step1_countif.gd（不改動原檔，原檔繼續
# 當獨立測試用的COUNTIF原型demo），給「Chapter1整合Demo」(09_chapter1_
# *)用。改動範圍只有：①TABLE_ONE_DATA/TABLE_TWO_NAMES從寫死的8人測試
# 資料改成依stage_id（由09_chapter1_dialogue.gd在實例化後設定）切換
# 案件一三關（COUNTIF/COUNTIFS/SUMIF）的真實資料，②新增puzzle_solved
# signal跟_check_stage_solved()，玩家打出正確答案時自動發出，讓母控制
# 場景知道這關過了、可以跳回劇情，③右側公式提示框依stage_id只列出
# 該關卡為止已教過的函數（讀case_data.excel_stages，不是固定全部顯示）。
# 其餘UI/公式引擎邏輯跟01完全相同，沒有重複實作。

signal puzzle_solved

# 由母控制場景（09_chapter1_dialogue.gd）在instantiate()之後、add_child()
# 之前設定，決定這個畫面要顯示案件一哪一關的真實資料。
var stage_id: String = "stage_countif"
var stage_already_solved := false
...
# 案件一三關的真實資料（破案關鍵資料依嚴格規則10寫死固定，不隨機）。
# 表格欄位沿用COL_PERSON~COL_NOTE既有的7個key（person/time/location/
# amount/item/witness/note），各關依教學情境重新賦予實際語意——欄位
# 本身的中文意義由案件目標／公式提示文字告訴玩家，表格本身只有Excel式
# 欄號(A、B、C...)，跟真實Excel一致，不額外畫語意標頭。
#
# 第一關 COUNTIF（場景④）：表一=簽到名冊(person姓名/time簽到時間)，
# 表二=離場記錄姓名清單(COL_REFERENCE_LIST)。15人簽到，14人有離場記錄，
# 唯獨貝洛特沒有。
const STAGE_COUNTIF_TABLE_ONE := [
	{"person": "貝洛特", "time": "16:00", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "席默", "time": "16:05", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "瑞娜", "time": "16:10", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "艾莎", "time": "16:15", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "諾爾", "time": "16:20", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "布蘭頓", "time": "16:25", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "薇拉", "time": "16:30", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "寇特", "time": "16:35", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "芬恩", "time": "16:40", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "瑪卓莉", "time": "16:45", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "奧斯丁", "time": "16:50", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "希爾", "time": "16:55", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "戴米恩", "time": "17:00", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "可琳", "time": "17:05", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
	{"person": "拉法葉", "time": "17:10", "location": "", "amount": "", "item": "", "witness": "", "note": ""},
]
const STAGE_COUNTIF_TABLE_TWO := ["席默", "瑞娜", "艾莎", "諾爾", "布蘭頓", "薇拉", "寇特", "芬恩", "瑪卓莉", "奧斯丁", "希爾", "戴米恩", "可琳", "拉法葉"]

# 第二關 COUNTIFS（場景⑥）：表三=區域進出記錄，location欄改放「區域」、
# amount欄改放「進入時間」、item欄改放「離場時間」。只有貝洛特同時符合
# 「洽談室」＋「進入<=17:30」＋「離場>=17:30」；席默全程在展示區（區域
# 不符，乾淨排除）；瑞娜/艾莎雖然也到過洽談室，但時間不落在案發空檔。
const STAGE_COUNTIFS_TABLE_ONE := [
	{"person": "貝洛特", "time": "", "location": "洽談室", "amount": "17:20", "item": "17:40", "witness": "", "note": ""},
	{"person": "席默", "time": "", "location": "展示區", "amount": "16:00", "item": "18:00", "witness": "", "note": ""},
	{"person": "瑞娜", "time": "", "location": "洽談室", "amount": "16:00", "item": "17:00", "witness": "", "note": ""},
	{"person": "艾莎", "time": "", "location": "洽談室", "amount": "17:35", "item": "17:50", "witness": "", "note": ""},
	{"person": "諾爾", "time": "", "location": "展示區", "amount": "16:10", "item": "18:00", "witness": "", "note": ""},
	{"person": "布蘭頓", "time": "", "location": "展示區", "amount": "16:15", "item": "18:00", "witness": "", "note": ""},
	{"person": "薇拉", "time": "", "location": "休息室", "amount": "17:00", "item": "17:45", "witness": "", "note": ""},
	{"person": "寇特", "time": "", "location": "展示區", "amount": "16:20", "item": "18:00", "witness": "", "note": ""},
	{"person": "芬恩", "time": "", "location": "展示區", "amount": "16:25", "item": "18:00", "witness": "", "note": ""},
	{"person": "瑪卓莉", "time": "", "location": "休息室", "amount": "17:10", "item": "17:25", "witness": "", "note": ""},
	{"person": "奧斯丁", "time": "", "location": "展示區", "amount": "16:30", "item": "18:00", "witness": "", "note": ""},
	{"person": "希爾", "time": "", "location": "展示區", "amount": "16:35", "item": "18:00", "witness": "", "note": ""},
	{"person": "戴米恩", "time": "", "location": "展示區", "amount": "16:40", "item": "18:00", "witness": "", "note": ""},
	{"person": "可琳", "time": "", "location": "展示區", "amount": "16:45", "item": "18:00", "witness": "", "note": ""},
	{"person": "拉法葉", "time": "", "location": "展示區", "amount": "16:50", "item": "18:00", "witness": "", "note": ""},
]
const STAGE_COUNTIFS_TABLE_TWO: Array = []

# 第三關 SUMIF（場景⑧）：表四=貝洛特費用申報明細，person欄改放「日期」、
# location欄改放「類別」、amount欄改放「金額」。雜項三筆300+475+500=1275。
const STAGE_SUMIF_TABLE_ONE := [
	{"person": "06-10", "time": "", "location": "餐飲", "amount": "45", "item": "", "witness": "", "note": ""},
	{"person": "06-10", "time": "", "location": "交通", "amount": "80", "item": "", "witness": "", "note": ""},
	{"person": "06-11", "time": "", "location": "雜項", "amount": "300", "item": "", "witness": "", "note": ""},
	{"person": "06-11", "time": "", "location": "住宿", "amount": "220", "item": "", "witness": "", "note": ""},
	{"person": "06-12", "time": "", "location": "雜項", "amount": "475", "item": "", "witness": "", "note": ""},
	{"person": "06-12", "time": "", "location": "餐飲", "amount": "60", "item": "", "witness": "", "note": ""},
	{"person": "06-13", "time": "", "location": "雜項", "amount": "500", "item": "", "witness": "", "note": ""},
	{"person": "06-13", "time": "", "location": "交通", "amount": "90", "item": "", "witness": "", "note": ""},
]
const STAGE_SUMIF_TABLE_TWO: Array = []

const STAGE_TABLE_DATA := {
	"stage_countif": {"table_one": STAGE_COUNTIF_TABLE_ONE, "table_two": STAGE_COUNTIF_TABLE_TWO},
	"stage_countifs": {"table_one": STAGE_COUNTIFS_TABLE_ONE, "table_two": STAGE_COUNTIFS_TABLE_TWO},
	"stage_sumif": {"table_one": STAGE_SUMIF_TABLE_ONE, "table_two": STAGE_SUMIF_TABLE_TWO},
}

# 每關「答對了」要檢查什麼：countif/countifs檢查貝洛特那一列的狀態欄
# 算出來的值是否等於expected_value；sumif檢查「任何一格狀態欄」算出來
# 的值是否等於expected_value（SUMIF公式本身不分人，答案只跟有沒有打對
# 公式有關，不綁特定列）。check_row_person為空字串代表用後者那種檢查法。
const STAGE_SOLVE_CHECK := {
	"stage_countif": {"check_row_person": "貝洛特", "expected_value": "0"},
	"stage_countifs": {"check_row_person": "貝洛特", "expected_value": "1"},
	"stage_sumif": {"check_row_person": "", "expected_value": "1275"},
}

# 由_ready()依stage_id指派成STAGE_TABLE_DATA其中一組，取代原本寫死的
# TABLE_ONE_DATA/TABLE_TWO_NAMES常數，下面所有原本讀常數的地方都改讀
# 這兩個變數。
var table_one_data: Array = []
var table_two_names: Array = []

const EXAMPLE_FORMULA = '=COUNTIF(J2:J9,A2)'

# 章節名稱/案件目標不再是寫死的占位文字，改用CaseData (07_case_data.gd)
# 讀data/cases/case_01.json。
...
func _ready() -> void:
	...
	stage_already_solved = false
	# 依母控制場景指定的stage_id，挑出案件一這一關的真實資料，要在
	# _build_grid()（透過下面的_build_ui()呼叫鏈）讀到table_one_data/
	# table_two_names之前就指派好。stage_id不在STAGE_TABLE_DATA裡時
	# 退回第一關資料，避免空陣列讓表格整個空白。
	var stage_table: Dictionary = STAGE_TABLE_DATA.get(stage_id, STAGE_TABLE_DATA["stage_countif"])
	table_one_data = stage_table["table_one"]
	table_two_names = stage_table["table_two"]
...
func _build_right_sidebar() -> PanelContainer:
	...
	for stage in case_data.get("excel_stages", []):
		var is_current_stage: bool = stage.get("stage_id", "") == stage_id
	...
	# 整合Demo版：不再只看FORMULA_HINTS的available=true（那代表「引擎
	# 有沒有實作」，COUNTIF/COUNTIFS/SUMIF三關都已經實作完成，三關全部
	# available=true），改成看case_data.excel_stages[stage_id]的
	# available_functions（那代表「教到這一關為止，劇情上教過哪些」，
	# 已經是累積式陣列，例如第二關是["COUNTIF","COUNTIFS"]）——只列出
	# 劇情教過的函數，不要在第一關就先暴雷後面的SUMIF。
	var stage_available_functions: Array = CaseData.get_excel_stage(case_data, stage_id).get("available_functions", [])
	for h in FORMULA_HINTS:
		if not stage_available_functions.has(h["name"]):
			continue
...
# 整合Demo專用：玩家每打對一格公式就檢查一次這關是不是已經解開。
# check_row_person有值（COUNTIF/COUNTIFS）→只看貝洛特那一列的狀態欄；
# check_row_person是空字串（SUMIF）→看是否「任何一格」狀態欄算出
# expected_value，因為SUMIF公式本身不分人，答案只跟公式對不對有關。
# 用stage_already_solved擋掉重複觸發，避免同一關答對後每改一次格子就
# 再發一次puzzle_solved訊號。
func _check_stage_solved() -> void:
	if stage_already_solved:
		return

	var check: Dictionary = STAGE_SOLVE_CHECK.get(stage_id, {})
	if check.is_empty():
		return

	var expected: String = check.get("expected_value", "")
	var check_person: String = check.get("check_row_person", "")

	var solved := false
	if check_person != "":
		for data_index in range(table_one_data.size()):
			if table_one_data[data_index].get("person", "") == check_person:
				var row := DATA_START_ROW + data_index
				var cell_id := COL_STATUS + str(row)
				if cell_value_lookup.get(cell_id, "") == expected:
					solved = true
				break
	else:
	...
	if solved:
		stage_already_solved = true
		var stage_info := CaseData.get_excel_stage(case_data, stage_id)
		_show_message("✓ " + str(stage_info.get("success_message", "過關！")))
		puzzle_solved.emit()
